...
public class PocmCrossTest {
    ...
    String token = "tNULSeBaMyPq6kY8wbofhqs1qpLhNGMJkbRpPh";
    String oldPocm = "tNULSeBaNBhoEs7eSbrbZFPXSFAZYDNWGToG17";
    String newPocm = "tNULSeBaN1gkWKWkivKCqFHX9skKGVw9kcn4f5";
    ...
    public void createPocmCross() throws Exception {
        ...
        Object[] args = new Object[]{
                "tNULSeBaMyPq6kY8wbofhqs1qpLhNGMJkbRpPh",
                "0",
                "0",
                "2000000000000000000",
                ...
                "1",
                "0",
                "14e1eb91-6f4e-4568-8d3e-b6e308c39fcc",
                "1",
                "2000"
        };
        String remark = "";
    ...
    public void transferCandyToPocm() throws JsonProcessingException {
        ...
        String priKey = _sender.getPriKey();
        BigInteger value = BigInteger.ZERO;
        String contractAddress = token;
        String methodName = "transfer";
        String methodDesc = "";
        Object[] args = new Object[]{newPocm, "200000000000000000000000"};
        String remark = "";
    ...
    public void deposit() throws Exception {
        ...
        String remark = "";
        int[] users = new int[]{3,38,6,19};
        String[] amounts = new String[]{"50000", "25000", "15000", "10000"};
