...
public class NAINFTTest {
    ...
    private String getMainUrl() {
        treasury = "NULSd6Hgex49Wn6sHr2KRqDefSamecFoeZdpC";
        //official = "NULSd6Hh9G9qZWzbWJKiJXVGnYRmxfv9qrxDM";
        official = "NULSd6HgcXrb14V5dqgRx1fo4816gNNVcpPih";
        ...
        this.sender01 = new Sender("NULSd6HgcXrb14V5dqgRx1fo4816gNNVcpPih",
                "");
        return mainUrl;
    }
    ...
    private String getTestUrl() {
        agentList = new ArrayList<>();
        agentList.add("73583f9795fb8f026f4a25d0a14d2abd72ce33581672ce1759c4c45a453ad992");
        return betaUrl;
    }

    private String getDevUrl() {
        agentList = new ArrayList<>();
        agentList.add("a3422eac43e226a97ea8129988c99554ebf3088c3b8264ee1f487160f1bce225");
        return devUrl;
    }
    ...
    public void testDomainOnlyCreateTxOffline() throws Exception {
        String token721 = "NULSd6HgnVhfWAVmnJ9vwK6jzdapWxJ53YZ1U";
        String staking = "NULSd6HgzG35AWGzFRQSX9URdtE9wKTorgqyw";
        String mainPath = "/Users/pierreluo/IdeaProjects/NulsNFTDefi/NulsNFTFIMint/target/NulsNFTFIMint-1.0-SNAPSHOT.jar";
        ...
        this._callTxOffline(BigInteger.ZERO, main, "initialize", "", new Object[]{staking, treasury, official, token721}, new String[]{"Address", "Address", "Address", "Address"}, "init");
    }
    ...
    public void test721OnlyCreateTxOffline() throws Exception {
        String token721Path = "/Users/pierreluo/IdeaProjects/NulsNFTDefi/NulsNFTFIToken/target/NulsNFTFIToken-1.0-SNAPSHOT.jar";
        String token721 = this._createTxOffline("token721", HexUtil.encode(IoUtils.readBytes(new File(token721Path))), new Object[]{"SwapNFT", "SwapNFT"}, new String[]{"String", "String"}, "token721");
        System.out.println(token721);
    }
     ...
     */
    @Test
    public void testStakingOnlyCreateTxOffline() throws Exception {
        String main = "tNULSeBaN2W2u3S3thVwxaPofYwigvQLjhb2i7";
        String stakingPath = "/Users/pierreluo/IdeaProjects/NulsNFTDefi/NulsNFTFIStaking/target/NulsNFTFIStaking-1.0-SNAPSHOT.jar";
        ...
        this._callTxOffline(BigInteger.ZERO, staking, "initialize", "", new Object[]{treasury, official, main}, new String[]{"Address", "Address", "Address"}, "init");
        TimeUnit.SECONDS.sleep(15);
        this._callTxOffline(BigInteger.ZERO, staking, "addOtherAgent", "", new Object[]{agentHash}, new String[]{"String"}, "init");
    }

    /**
     * create main + 721 + staking
     */
    @Test
    public void testMainAllCreateTxOffline() throws Exception {
        ...
        this._callTxOffline(BigInteger.ZERO, main, "initialize", "", new Object[]{staking, treasury, official, token721}, new String[]{"Address", "Address", "Address", "Address"}, "init");
        TimeUnit.SECONDS.sleep(15);
        this._callTxOffline(BigInteger.ZERO, staking, "initialize", "", new Object[]{treasury, official}, new String[]{"Address", "Address"}, "init");
     ...
     */
    @Test
    public void testMainAnd721CreateTxOffline() throws Exception {
    ...
    public void testMain2CreateTxOffline() throws Exception {
        String token721 = "tNULSeBaN2YPosmh9RBD6pN95BFjCdBSUZccyt";
        String mainPath = "/Users/pierreluo/IdeaProjects/NulsNFTDefi/NulsNFTFIMint/target/NulsNFTFIMint-1.0-SNAPSHOT.jar";
        String stakingPath = "/Users/pierreluo/IdeaProjects/NulsNFTDefi/NulsNFTFIStaking/target/NulsNFTFIStaking-1.0-SNAPSHOT.jar";
    ...
    /**
     * initialize main + staking
     */
    @Test
    public void testDomainInitializeTxOffline() throws Exception {
        String main = "tNULSeBaN2W2u3S3thVwxaPofYwigvQLjhb2i7";
        String token721 = "tNULSeBaN7WM6dWv4VXo6G4YDUkoQ9DqGmGGDp";
        String staking = "tNULSeBaN2ZojM9a2cyiyuN2QYTKud4qvFeQq8";
        //this._callTxOffline(BigInteger.ZERO, main, "initialize", "", new Object[]{staking, treasury, official, token721}, new String[]{"Address", "Address", "Address", "Address"}, "init");
        //TimeUnit.SECONDS.sleep(15);
        this._callTxOffline(BigInteger.ZERO, staking, "initialize", "", new Object[]{treasury, official}, new String[]{"Address", "Address"}, "init");
        TimeUnit.SECONDS.sleep(10);
