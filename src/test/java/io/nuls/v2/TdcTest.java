...
public class TdcTest {
    ...
    String officialTdc = "tNULSeBaMoixxbUovqmzPyJ2AwYFAX2evKbuy9";
    String tdcToken = "tNULSeBaN2QVohyKMFt24EgKzrwgww3xgbU97z";
    String agentHash;
    List<String> agentList = new ArrayList<>();

    private String getMainUrl() {
        //管理员地址：NULSd6Hgc6GXLTeh5jwzqmUc6ZrwR34RMSRVr
        //奖励地址：NULSd6HgcEeqiv4mTnQT21oCjxRerF7hjwu5e
        treasury = "NULSd6HgcEeqiv4mTnQT21oCjxRerF7hjwu5e";
        official = "NULSd6HhDEf67P5TRX5tw2vZZbCJC98UU4xL9";
        officialTdc = "NULSd6Hgc6GXLTeh5jwzqmUc6ZrwR34RMSRVr";
        tdcToken = "NULSd6HgxbgiGLdyMc8DD9ZsTxrGNFWHeWsdr";
        ...
        agentList.add("540e58834a45c29d64762a381b25f8645755234084cf955f32aea820025eeea0");//zlj
        agentList.add("16b39c65a61c22ca30d3e60def9faaff2f07d59a54c32106a15926e498ce1b76");//98ce1b76
        this.sender01 = new Sender("NULSd6HgZTZzPM488RCiXZKcTMjoKV48nHKeU",
                "???");
        return mainUrl;
    }
    ...
    //    String token = "tNULSeBaMvphViewD1t6z53939awnK2PtDeBb9";
    //    String mainPath = "/Users/pierreluo/IdeaProjects/naiPumpContract/AIPump/target/AIPump-1.0-SNAPSHOT.jar";
    //    String main = this._createTxOffline("main", HexUtil.encode(IoUtils.readBytes(new File(mainPath))), new Object[]{treasury, token, official}, new String[]{"Address", "Address", "Address"}, "main");
    //    System.out.println();
    //}
    //
    ///**
    ...
    // */
    //@Test
    //public void testTokenOnlyCreateTxOffline() throws Exception {
    //    String tokenPath = "/Users/pierreluo/IdeaProjects/naiPumpContract/AIPumpToken/target/AIPumpToken-1.0-SNAPSHOT.jar";
    //    String token = this._createTxOffline("token", HexUtil.encode(IoUtils.readBytes(new File(tokenPath))), new Object[]{}, new String[]{}, "token");
    //}
     ...
     */
    @Test
    public void testStakingCreateTxOffline() throws Exception {
        //String main = "tNULSeBaN2UMNXd6YhzUB5A9X99nwn1PLcDby7";
        //String stakingPath = "/Users/pierreluo/IdeaProjects/TdcContract/TdcStaking/target/TdcStaking-1.0-SNAPSHOT.jar";
        //
        ...
        //this._callTxOffline(BigInteger.ZERO, staking, "initialize", "", new Object[]{treasury, official, tdcToken, main}, new String[]{"Address", "Address", "Address", "Address"}, "init");

        String staking = "NULSd6Hgu1TBRqyochBknJHzDCz4oXkiGnDUj";
    ...
    public void testMainAllCreateTxOffline() throws Exception {
        String mainPath = "/Users/pierreluo/IdeaProjects/TdcContract/Tdc/target/Tdc-1.0-SNAPSHOT.jar";
        String token721Path = "/Users/pierreluo/IdeaProjects/TdcContract/TdcNRC721/target/TdcNRC721-1.0-SNAPSHOT.jar";
        String stakingPath = "/Users/pierreluo/IdeaProjects/TdcContract/TdcStaking/target/TdcStaking-1.0-SNAPSHOT.jar";

        String main = this._createTxOffline("main", HexUtil.encode(IoUtils.readBytes(new File(mainPath))), new Object[]{}, new String[]{}, "main");
        TimeUnit.SECONDS.sleep(5);
        String token721 = this._createTxOffline("token", HexUtil.encode(IoUtils.readBytes(new File(token721Path))), new Object[]{"TDC", "TDC"}, new String[]{"String", "String"}, "token721");
        TimeUnit.SECONDS.sleep(5);
        String staking = this._createTxOffline("staking", HexUtil.encode(IoUtils.readBytes(new File(stakingPath))), new Object[]{}, new String[]{}, "staking");
        TimeUnit.SECONDS.sleep(15);
        this._callTxOffline(BigInteger.ZERO, main, "initialize", "", new Object[]{staking, treasury, officialTdc, token721}, new String[]{"Address", "Address", "Address", "Address"}, "init");
        TimeUnit.SECONDS.sleep(15);
        this._callTxOffline(BigInteger.ZERO, token721, "initialize", "", new Object[]{official, main}, new String[]{"Address", "Address"}, "init");
        TimeUnit.SECONDS.sleep(15);
        this._callTxOffline(BigInteger.ZERO, staking, "initialize", "", new Object[]{treasury, official, tdcToken, main}, new String[]{"Address", "Address", "Address", "Address"}, "init");
